...
import FixPriceModule from './components/FixPriceModule'
import CoherenceModule from './components/CoherenceModule'
    ...
    <div className="flex h-screen bg-luxarmonie-gray-50">
      ...
      <main className="flex-1 overflow-auto">
        <div className="p-8">
          ...
          {activeModule === 'fix-price' && <FixPriceModule />}
          {activeModule === 'coherence' && <CoherenceModule />}
          {activeModule === 'csv' && <CSVModule />}

          {/* Placeholder pour futurs modules */}
          {!['pricing', 'fix-price', 'coherence', 'csv'].includes(activeModule) && (
